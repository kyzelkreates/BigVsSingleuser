/**
 * ============================================================
 * Big V's Best Routes™ — Top Navigation Bar
...
function Breadcrumb({ pathname }) {
  ...
  return (
    <div className="flex items-center gap-2 text-sm">
      <span className="text-slate-600">Big V's Best Routes™</span>
...
function LiveClock() {
  ...
  return (
    <div className="flex flex-col items-end">
      <span className="font-mono text-[#d4a017] text-sm tabular-nums">
...
function UserMenu({ user, roleLabel, signOut }) {
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="w-7 h-7 rounded-md bg-[#b8860b]/15 border border-[#b8860b]/30 flex items-center justify-center">
          <span className="text-[#d4a017] text-xs font-bold">{initials}</span>
        </div>
        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-2 w-56 bg-[#0d1426] border border-slate-800/60 rounded-xl shadow-xl z-50 overflow-hidden">
            ...
            <div className="px-4 py-3 border-b border-slate-800/60">
              ...
              <span className="inline-block mt-1 text-2xs text-[#d4a017] bg-[#b8860b]/10 px-2 py-0.5 rounded border border-[#b8860b]/25">
                {roleLabel}
              </span>
            </div>
...
export default function TopNav() {
  ...
  return (
    <header className="flex items-center justify-between h-13 px-4 border-b border-[#2a1f00]/60 bg-[#070708]/95 backdrop-blur-sm flex-shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden lg:flex items-center gap-2 bg-violet-500/5 border border-violet-500/20 rounded-full px-3 py-1.5">
          ...
          <span className="text-xs text-violet-400 font-medium">4P3X AI Ready</span>
        </div>
        <div className="flex">
          <LiveClock />
        </div>
